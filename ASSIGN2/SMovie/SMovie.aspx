            ...
            <div class="col-md-7 col-xs-12 col-sm-6 spaceabove">
                ...
                <div class="panel panel-default bioClear">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox ID="txtFirstName" placeholder="Enter First Name" runat="server"></asp:TextBox><br />
                                                <br />
                                                <asp:Label ID="lblLname" runat="server" Text="Last Name"></asp:Label><br />
                                                <asp:TextBox ID="txtLastName" placeholder="Enter Last Name" runat="server"></asp:TextBox><br />
                                                <br />

                                                <asp:Label ID="lblTItle" runat="server" Text="Review Title"></asp:Label><br />
                                                <asp:TextBox ID="txtReviewTitle" placeholder="Enter Review Title Here" runat="server"></asp:TextBox><br />
                                                <br />

                                                Rating:
                                                <input type="text" id="rating1" class="rating rating5" value="0" runat="server" />
                    ...
                    <div class="panel-body">
                        ...
                        <b>
                            <p>
                                IMDB: <%-- <a id="linkIMDB" runat="server"> --%>
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="col-md-6">
                            <div class="panel-title">
                                ...
                                <asp:Label ID="lblReviewScore" runat="server" Text=<%# "Score: " + Eval("rating") +"/5" %>></asp:Label>
                                <br />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <b>
                                <asp:Label ID="lblReviewTtile" runat="server"><%# Eval("review_title" )%></asp:Label></b>
                            <br />
